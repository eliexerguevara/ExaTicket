const messages = {
  es: {
    translations: {
      ...
      aiChat: {
        takingControl: "Tomar control",
        aiHandling: "Atendido por IA",
        tooltip: "La IA está atendiendo este ticket. Haz clic para tomar el control.",
        settings: {
          title: "IA de Soporte Técnico",
          enabled: "Activar IA de soporte",
          systemPrompt: "Instrucciones para la IA (prompt del sistema)",
          maxAttempts: "Intentos máximos antes de escalar a operador",
          escalationMessage: "Mensaje al transferir a operador",
          save: "Guardar",
          options: {
            enabled: "Habilitado",
            disabled: "Deshabilitado",
