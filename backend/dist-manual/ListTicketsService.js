...
const ListTicketsService = ({ searchParam = "", pageNumber = "1", queueIds, status, date, showAll, userId, withUnreadMessages, isGroup }) => __awaiter(void 0, void 0, void 0, function* () {
    let whereCondition = {
    ...
    includeCondition = [
        ...
        {
            model: Telegram_1.default,
            as: "telegram",
            attributes: ["name"],
            required: false
        },
        {
            model: Label_1.default,
            as: "labels",
            attributes: ["id", "name", "color"],
            through: { attributes: [] }
        }
    ...
    if (isGroup === "true") {
        if (showAll === "true") {
            ...
            whereCondition = Object.assign(Object.assign({}, whereCondition), { isGroup: true, status: { [sequelize_1.Op.ne]: "closed" } });
        }
    }
    else if (isGroup === "false") {
        whereCondition = Object.assign(Object.assign({}, whereCondition), { isGroup: false });
    }
    const limit = 40;
